...
namespace AetherMod.NPCs.TownNPCs            //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class Lumberjack : ModNPC
    {
        ...
        {
              //this is an example of how to add your item
            shop.item[nextSlot].SetDefaults(ItemID.Wood);
			shop.item[nextSlot].shopCustomPrice = 3;
			nextSlot++;
            shop.item[nextSlot].SetDefaults(mod.ItemType("Lumberjack's Axe"));
            nextSlot++;
        ...
        public override string GetChat()       //Allows you to give this town NPC a chat message when a player talks to it.
        {
            ...
            {
                case 0:
                    return "Chop all day long, chop....Oh hey!";
                case 1:
                    return "I'm not just gonna' get you wood for free you know...";
                case 2:
                    return "Hey, my brother once got into some reeeallly weird stuff. Like occult. Keep an eye out for anything...voodoo.";
                case 3:
                    return "If you prove yourself, my axe could be yours.";
                default:
                    return "One day, I hope to become my work. A tree.";
        ...
        {
            scale = -0.1f;
            item = Main.itemTexture[mod.ItemType("LumberjacksAxe")]; //this defines the item that this npc will use
        }
