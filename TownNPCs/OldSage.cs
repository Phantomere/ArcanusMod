...
namespace AetherMod.NPCs.TownNPCs           //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class OldSage : ModNPC
    {
        ...
        public override void SetupShop(Chest shop, ref int nextSlot)       //Allows you to add items to this town NPC's shop. Add an item by setting the defaults of shop.item[nextSlot] then incrementing nextSlot.
        {
            if (NPC.downedSlimeKing)   //this make so when the king slime is killed the town npc will sell this
            {
                ...
                shop.item[nextSlot].shopCustomPrice = 20;//an example of how to add a vanilla terraria item
                nextSlot++;
            ...
            nextSlot++;
            shop.item[nextSlot].SetDefaults(ItemID.Blinkroot);  //this is an example of how to add a modded item
            nextSlot++;
            shop.item[nextSlot].SetDefaults(ItemID.Daybloom);  //this is an example of how to add a modded item
            nextSlot++;
            shop.item[nextSlot].SetDefaults(ItemID.Shiverthorn);  //this is an example of how to add a modded item
            nextSlot++;
        ...
        public override string GetChat()       //Allows you to give this town NPC a chat message when a player talks to it.
        {
            ...
            {
                case 0:
                    return "Don't let 'em lie to you...Getting old sucks.";
                case 1:
                    return "Wise? Well, I guess if you want me to be.";
                case 2:
                    return "When I was just a boy, the Wizard Guild imprisoned a very powerful mage for becoming to ambitious...let's hope he isn't found.";
                case 3:
                    return "My, my, aren't you a spry fella'. Just like my ex-wife...she was a panther. No. I'm serious.";
                default:
                    return "Why does everyone keep asking me for dyes?";
